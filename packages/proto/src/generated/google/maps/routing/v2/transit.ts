...
export const TransitAgency: MessageFns<TransitAgency> = {
  ...
  create<I extends Exact<DeepPartial<TransitAgency>, I>>(base?: I): TransitAgency {
    return TransitAgency.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<TransitAgency>, I>>(object: I): TransitAgency {
    const message = createBaseTransitAgency();
...
export const TransitLine: MessageFns<TransitLine> = {
  ...
  create<I extends Exact<DeepPartial<TransitLine>, I>>(base?: I): TransitLine {
    return TransitLine.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<TransitLine>, I>>(object: I): TransitLine {
    const message = createBaseTransitLine();
...
export const TransitStop: MessageFns<TransitStop> = {
  ...
  create<I extends Exact<DeepPartial<TransitStop>, I>>(base?: I): TransitStop {
    return TransitStop.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<TransitStop>, I>>(object: I): TransitStop {
    const message = createBaseTransitStop();
    message.name = object.name ?? "";
...
export const TransitVehicle: MessageFns<TransitVehicle> = {
  ...
  create<I extends Exact<DeepPartial<TransitVehicle>, I>>(base?: I): TransitVehicle {
    return TransitVehicle.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<TransitVehicle>, I>>(object: I): TransitVehicle {
    const message = createBaseTransitVehicle();
