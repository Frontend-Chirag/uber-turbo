...
import { FallbackInfo } from "./fallback_info";
import { GeocodingResults } from "./geocoding_results";
import {
  PolylineEncoding,
...
import { Route, RouteTravelAdvisory } from "./route";
import { RouteModifiers } from "./route_modifiers";
import { RouteTravelMode, routeTravelModeFromJSON, routeTravelModeToJSON } from "./route_travel_mode";
import { RoutingPreference, routingPreferenceFromJSON, routingPreferenceToJSON } from "./routing_preference";
import { TrafficModel, trafficModelFromJSON, trafficModelToJSON } from "./traffic_model";
import { TransitPreferences } from "./transit_preferences";
import { Units, unitsFromJSON, unitsToJSON } from "./units";
...
export enum ComputeRoutesRequest_ReferenceRoute {
  ...
  FUEL_EFFICIENT = 1,
  /**
   * SHORTER_DISTANCE - Route with shorter travel distance. This is an experimental feature.
   *
...
export function computeRoutesRequest_ReferenceRouteFromJSON(object: any): ComputeRoutesRequest_ReferenceRoute {
  switch (object) {
    ...
    case "SHORTER_DISTANCE":
      return ComputeRoutesRequest_ReferenceRoute.SHORTER_DISTANCE;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function computeRoutesRequest_ReferenceRouteToJSON(object: ComputeRoutesRequest_ReferenceRoute): string {
  switch (object) {
    ...
    case ComputeRoutesRequest_ReferenceRoute.SHORTER_DISTANCE:
...
export enum ComputeRoutesRequest_ExtraComputation {
  ...
  /**
   * FLYOVER_INFO_ON_POLYLINE - Flyover information for the route(s). The
  ...
  /**
   * NARROW_ROAD_INFO_ON_POLYLINE - Narrow road information for the route(s). The
...
export function computeRoutesRequest_ExtraComputationFromJSON(object: any): ComputeRoutesRequest_ExtraComputation {
  switch (object) {
    ...
    case "FLYOVER_INFO_ON_POLYLINE":
      return ComputeRoutesRequest_ExtraComputation.FLYOVER_INFO_ON_POLYLINE;
    case 8:
    case "NARROW_ROAD_INFO_ON_POLYLINE":
      return ComputeRoutesRequest_ExtraComputation.NARROW_ROAD_INFO_ON_POLYLINE;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function computeRoutesRequest_ExtraComputationToJSON(object: ComputeRoutesRequest_ExtraComputation): string {
  switch (object) {
    ...
    case ComputeRoutesRequest_ExtraComputation.FLYOVER_INFO_ON_POLYLINE:
      return "FLYOVER_INFO_ON_POLYLINE";
    case ComputeRoutesRequest_ExtraComputation.NARROW_ROAD_INFO_ON_POLYLINE:
...
export const ComputeRoutesRequest: MessageFns<ComputeRoutesRequest> = {
  ...
  create<I extends Exact<DeepPartial<ComputeRoutesRequest>, I>>(base?: I): ComputeRoutesRequest {
    return ComputeRoutesRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ComputeRoutesRequest>, I>>(object: I): ComputeRoutesRequest {
    const message = createBaseComputeRoutesRequest();
...
export const ComputeRoutesResponse: MessageFns<ComputeRoutesResponse> = {
  ...
  create<I extends Exact<DeepPartial<ComputeRoutesResponse>, I>>(base?: I): ComputeRoutesResponse {
    return ComputeRoutesResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ComputeRoutesResponse>, I>>(object: I): ComputeRoutesResponse {
    const message = createBaseComputeRoutesResponse();
...
export const ComputeRouteMatrixRequest: MessageFns<ComputeRouteMatrixRequest> = {
  ...
  create<I extends Exact<DeepPartial<ComputeRouteMatrixRequest>, I>>(base?: I): ComputeRouteMatrixRequest {
    return ComputeRouteMatrixRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ComputeRouteMatrixRequest>, I>>(object: I): ComputeRouteMatrixRequest {
    const message = createBaseComputeRouteMatrixRequest();
...
export const RouteMatrixOrigin: MessageFns<RouteMatrixOrigin> = {
  ...
  create<I extends Exact<DeepPartial<RouteMatrixOrigin>, I>>(base?: I): RouteMatrixOrigin {
    return RouteMatrixOrigin.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RouteMatrixOrigin>, I>>(object: I): RouteMatrixOrigin {
    const message = createBaseRouteMatrixOrigin();
...
export const RouteMatrixDestination: MessageFns<RouteMatrixDestination> = {
  ...
  create<I extends Exact<DeepPartial<RouteMatrixDestination>, I>>(base?: I): RouteMatrixDestination {
    return RouteMatrixDestination.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RouteMatrixDestination>, I>>(object: I): RouteMatrixDestination {
    const message = createBaseRouteMatrixDestination();
    message.waypoint = (object.waypoint !== undefined && object.waypoint !== null)
      ? Waypoint.fromPartial(object.waypoint)
      : undefined;
...
export const RouteMatrixElement: MessageFns<RouteMatrixElement> = {
  ...
  create<I extends Exact<DeepPartial<RouteMatrixElement>, I>>(base?: I): RouteMatrixElement {
    return RouteMatrixElement.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RouteMatrixElement>, I>>(object: I): RouteMatrixElement {
    const message = createBaseRouteMatrixElement();
...
export const RouteMatrixElement_LocalizedValues: MessageFns<RouteMatrixElement_LocalizedValues> = {
  ...
  create<I extends Exact<DeepPartial<RouteMatrixElement_LocalizedValues>, I>>(
    base?: I,
  ): RouteMatrixElement_LocalizedValues {
    return RouteMatrixElement_LocalizedValues.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RouteMatrixElement_LocalizedValues>, I>>(
    object: I,
  ): RouteMatrixElement_LocalizedValues {
    const message = createBaseRouteMatrixElement_LocalizedValues();
...
/** The Routes API. */
export type RoutesService = typeof RoutesService;
export const RoutesService = {
   ...
   */
  computeRoutes: {
    path: "/google.maps.routing.v2.Routes/ComputeRoutes",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ComputeRoutesRequest): Buffer => Buffer.from(ComputeRoutesRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): ComputeRoutesRequest => ComputeRoutesRequest.decode(value),
    responseSerialize: (value: ComputeRoutesResponse): Buffer =>
      Buffer.from(ComputeRoutesResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): ComputeRoutesResponse => ComputeRoutesResponse.decode(value),
  },
  /**
   ...
   */
  computeRouteMatrix: {
    path: "/google.maps.routing.v2.Routes/ComputeRouteMatrix",
    requestStream: false,
    responseStream: true,
    requestSerialize: (value: ComputeRouteMatrixRequest): Buffer =>
      Buffer.from(ComputeRouteMatrixRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): ComputeRouteMatrixRequest => ComputeRouteMatrixRequest.decode(value),
    responseSerialize: (value: RouteMatrixElement): Buffer => Buffer.from(RouteMatrixElement.encode(value).finish()),
    responseDeserialize: (value: Buffer): RouteMatrixElement => RouteMatrixElement.decode(value),
  },
} as const;

export interface RoutesServer extends UntypedServiceImplementation {
  /**
   * Returns the primary route along with optional alternate routes, given a set
   * of terminal and intermediate waypoints.
   *
   ...
   * size, and thus higher network throughput.
   */
  computeRoutes: handleUnaryCall<ComputeRoutesRequest, ComputeRoutesResponse>;
  /**
   * Takes in a list of origins and destinations and returns a stream containing
   * route information for each combination of origin and destination.
   *
   ...
   * size, and thus higher network throughput.
   */
  computeRouteMatrix: handleServerStreamingCall<ComputeRouteMatrixRequest, RouteMatrixElement>;
}

export interface RoutesClient extends Client {
  /**
   * Returns the primary route along with optional alternate routes, given a set
   * of terminal and intermediate waypoints.
   *
  ...
  computeRoutes(
    ...
    callback: (error: ServiceError | null, response: ComputeRoutesResponse) => void,
  ): ClientUnaryCall;
  computeRoutes(
    request: ComputeRoutesRequest,
    metadata: Metadata,
  ...
  computeRouteMatrix(
    ...
    options?: Partial<CallOptions>,
  ): ClientReadableStream<RouteMatrixElement>;
  computeRouteMatrix(
    request: ComputeRouteMatrixRequest,
    metadata?: Metadata,
    options?: Partial<CallOptions>,
...
export const RoutesClient = makeGenericClientConstructor(RoutesService, "google.maps.routing.v2.Routes") as unknown as {
  new (address: string, credentials: ChannelCredentials, options?: Partial<ClientOptions>): RoutesClient;
  service: typeof RoutesService;
  serviceName: string;
};
