...
import { VehicleEmissionType, vehicleEmissionTypeFromJSON, vehicleEmissionTypeToJSON } from "./vehicle_emission_type";
...
export const VehicleInfo: MessageFns<VehicleInfo> = {
  ...
  create<I extends Exact<DeepPartial<VehicleInfo>, I>>(base?: I): VehicleInfo {
    return VehicleInfo.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<VehicleInfo>, I>>(object: I): VehicleInfo {
    const message = createBaseVehicleInfo();
