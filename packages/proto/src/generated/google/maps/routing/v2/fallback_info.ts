...
export enum FallbackRoutingMode {
  ...
  /**
   * FALLBACK_TRAFFIC_UNAWARE - Indicates the `TRAFFIC_UNAWARE`
   * [`RoutingPreference`][google.maps.routing.v2.RoutingPreference] was used to
   * compute the response.
   */
  FALLBACK_TRAFFIC_UNAWARE = 1,
  /**
   * FALLBACK_TRAFFIC_AWARE - Indicates the `TRAFFIC_AWARE`
   * [`RoutingPreference`][google.maps.routing.v2.RoutingPreference] was used to
   * compute the response.
   */
...
export const FallbackInfo: MessageFns<FallbackInfo> = {
  ...
  create<I extends Exact<DeepPartial<FallbackInfo>, I>>(base?: I): FallbackInfo {
    return FallbackInfo.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<FallbackInfo>, I>>(object: I): FallbackInfo {
    const message = createBaseFallbackInfo();
