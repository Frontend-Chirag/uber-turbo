...
export const TransitPreferences: MessageFns<TransitPreferences> = {
  ...
  create<I extends Exact<DeepPartial<TransitPreferences>, I>>(base?: I): TransitPreferences {
    return TransitPreferences.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<TransitPreferences>, I>>(object: I): TransitPreferences {
    const message = createBaseTransitPreferences();
