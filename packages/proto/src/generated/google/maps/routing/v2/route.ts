...
import { Viewport } from "../../../geo/type/viewport";
import { Duration } from "../../../protobuf/duration";
import { Timestamp } from "../../../protobuf/timestamp";
import { LocalizedText } from "../../../type/localized_text";
import { Money } from "../../../type/money";
import { LocalizedTime } from "./localized_time";
import { Location } from "./location";
import { NavigationInstruction } from "./navigation_instruction";
import { Polyline } from "./polyline";
import { PolylineDetails } from "./polyline_details";
import { RouteLabel, routeLabelFromJSON, routeLabelToJSON } from "./route_label";
import { RouteTravelMode, routeTravelModeFromJSON, routeTravelModeToJSON } from "./route_travel_mode";
import { SpeedReadingInterval } from "./speed_reading_interval";
import { TollInfo } from "./toll_info";
import { TransitLine, TransitStop } from "./transit";
...
export interface Route {
  ...
  polylineDetails: PolylineDetails | undefined;
}
...
export const Route: MessageFns<Route> = {
  encode(message: Route, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.polylineDetails !== undefined) {
      PolylineDetails.encode(message.polylineDetails, writer.uint32(114).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 14: {
          ...
          message.polylineDetails = PolylineDetails.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): Route {
    return {
      ...
      polylineDetails: isSet(object.polylineDetails) ? PolylineDetails.fromJSON(object.polylineDetails) : undefined,
    };
  },
  ...
  toJSON(message: Route): unknown {
    ...
    if (message.polylineDetails !== undefined) {
      obj.polylineDetails = PolylineDetails.toJSON(message.polylineDetails);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Route>, I>>(object: I): Route {
    ...
    message.polylineDetails = (object.polylineDetails !== undefined && object.polylineDetails !== null)
      ? PolylineDetails.fromPartial(object.polylineDetails)
      : undefined;
    return message;
  },
};
...
export const Route_RouteLocalizedValues: MessageFns<Route_RouteLocalizedValues> = {
  ...
  create<I extends Exact<DeepPartial<Route_RouteLocalizedValues>, I>>(base?: I): Route_RouteLocalizedValues {
    return Route_RouteLocalizedValues.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Route_RouteLocalizedValues>, I>>(object: I): Route_RouteLocalizedValues {
    const message = createBaseRoute_RouteLocalizedValues();
...
export const RouteTravelAdvisory: MessageFns<RouteTravelAdvisory> = {
  encode(message: RouteTravelAdvisory, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.fuelConsumptionMicroliters !== 0) {
      writer.uint32(40).int64(message.fuelConsumptionMicroliters);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5: {
          ...
          message.fuelConsumptionMicroliters = longToNumber(reader.int64());
          continue;
        }
        case 6: {
          if (tag !== 48) {
  ...
  fromJSON(object: any): RouteTravelAdvisory {
    return {
      ...
      fuelConsumptionMicroliters: isSet(object.fuelConsumptionMicroliters)
        ? globalThis.Number(object.fuelConsumptionMicroliters)
        : 0,
  ...
  toJSON(message: RouteTravelAdvisory): unknown {
    ...
    if (message.fuelConsumptionMicroliters !== 0) {
      obj.fuelConsumptionMicroliters = Math.round(message.fuelConsumptionMicroliters);
    }
    if (message.routeRestrictionsPartiallyIgnored !== false) {
  ...
  create<I extends Exact<DeepPartial<RouteTravelAdvisory>, I>>(base?: I): RouteTravelAdvisory {
    return RouteTravelAdvisory.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RouteTravelAdvisory>, I>>(object: I): RouteTravelAdvisory {
    const message = createBaseRouteTravelAdvisory();
    ...
    message.fuelConsumptionMicroliters = object.fuelConsumptionMicroliters ?? 0;
...
export const RouteLegTravelAdvisory: MessageFns<RouteLegTravelAdvisory> = {
  ...
  create<I extends Exact<DeepPartial<RouteLegTravelAdvisory>, I>>(base?: I): RouteLegTravelAdvisory {
    return RouteLegTravelAdvisory.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RouteLegTravelAdvisory>, I>>(object: I): RouteLegTravelAdvisory {
    const message = createBaseRouteLegTravelAdvisory();
    message.tollInfo = (object.tollInfo !== undefined && object.tollInfo !== null)
      ? TollInfo.fromPartial(object.tollInfo)
      : undefined;
...
export const RouteLegStepTravelAdvisory: MessageFns<RouteLegStepTravelAdvisory> = {
  ...
  create<I extends Exact<DeepPartial<RouteLegStepTravelAdvisory>, I>>(base?: I): RouteLegStepTravelAdvisory {
    return RouteLegStepTravelAdvisory.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RouteLegStepTravelAdvisory>, I>>(object: I): RouteLegStepTravelAdvisory {
    const message = createBaseRouteLegStepTravelAdvisory();
    message.speedReadingIntervals = object.speedReadingIntervals?.map((e) => SpeedReadingInterval.fromPartial(e)) || [];
    return message;
  },
...
export const RouteLeg_RouteLegLocalizedValues: MessageFns<RouteLeg_RouteLegLocalizedValues> = {
  ...
  create<I extends Exact<DeepPartial<RouteLeg_RouteLegLocalizedValues>, I>>(
    base?: I,
  ): RouteLeg_RouteLegLocalizedValues {
    return RouteLeg_RouteLegLocalizedValues.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RouteLeg_RouteLegLocalizedValues>, I>>(
    object: I,
  ): RouteLeg_RouteLegLocalizedValues {
    const message = createBaseRouteLeg_RouteLegLocalizedValues();
    message.distance = (object.distance !== undefined && object.distance !== null)
...
export const RouteLeg_StepsOverview: MessageFns<RouteLeg_StepsOverview> = {
  ...
  create<I extends Exact<DeepPartial<RouteLeg_StepsOverview>, I>>(base?: I): RouteLeg_StepsOverview {
    return RouteLeg_StepsOverview.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RouteLeg_StepsOverview>, I>>(object: I): RouteLeg_StepsOverview {
    const message = createBaseRouteLeg_StepsOverview();
...
export const RouteLeg_StepsOverview_MultiModalSegment: MessageFns<RouteLeg_StepsOverview_MultiModalSegment> = {
  ...
  create<I extends Exact<DeepPartial<RouteLeg_StepsOverview_MultiModalSegment>, I>>(
    base?: I,
  ): RouteLeg_StepsOverview_MultiModalSegment {
    return RouteLeg_StepsOverview_MultiModalSegment.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RouteLeg_StepsOverview_MultiModalSegment>, I>>(
    object: I,
  ): RouteLeg_StepsOverview_MultiModalSegment {
    const message = createBaseRouteLeg_StepsOverview_MultiModalSegment();
...
export const RouteLegStep: MessageFns<RouteLegStep> = {
  ...
  create<I extends Exact<DeepPartial<RouteLegStep>, I>>(base?: I): RouteLegStep {
    return RouteLegStep.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RouteLegStep>, I>>(object: I): RouteLegStep {
    const message = createBaseRouteLegStep();
    message.distanceMeters = object.distanceMeters ?? 0;
    message.staticDuration = (object.staticDuration !== undefined && object.staticDuration !== null)
      ? Duration.fromPartial(object.staticDuration)
...
export const RouteLegStep_RouteLegStepLocalizedValues: MessageFns<RouteLegStep_RouteLegStepLocalizedValues> = {
  ...
  create<I extends Exact<DeepPartial<RouteLegStep_RouteLegStepLocalizedValues>, I>>(
    base?: I,
  ): RouteLegStep_RouteLegStepLocalizedValues {
    return RouteLegStep_RouteLegStepLocalizedValues.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RouteLegStep_RouteLegStepLocalizedValues>, I>>(
    object: I,
  ): RouteLegStep_RouteLegStepLocalizedValues {
    const message = createBaseRouteLegStep_RouteLegStepLocalizedValues();
    message.distance = (object.distance !== undefined && object.distance !== null)
...
export const RouteLegStepTransitDetails: MessageFns<RouteLegStepTransitDetails> = {
  ...
  create<I extends Exact<DeepPartial<RouteLegStepTransitDetails>, I>>(base?: I): RouteLegStepTransitDetails {
    return RouteLegStepTransitDetails.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RouteLegStepTransitDetails>, I>>(object: I): RouteLegStepTransitDetails {
    const message = createBaseRouteLegStepTransitDetails();
...
export const RouteLegStepTransitDetails_TransitStopDetails: MessageFns<RouteLegStepTransitDetails_TransitStopDetails> =
  {
    ...
    create<I extends Exact<DeepPartial<RouteLegStepTransitDetails_TransitStopDetails>, I>>(
      base?: I,
    ): RouteLegStepTransitDetails_TransitStopDetails {
      return RouteLegStepTransitDetails_TransitStopDetails.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<RouteLegStepTransitDetails_TransitStopDetails>, I>>(
      object: I,
    ): RouteLegStepTransitDetails_TransitStopDetails {
      const message = createBaseRouteLegStepTransitDetails_TransitStopDetails();
...
> = {
  ...
  create<I extends Exact<DeepPartial<RouteLegStepTransitDetails_TransitDetailsLocalizedValues>, I>>(
    base?: I,
  ): RouteLegStepTransitDetails_TransitDetailsLocalizedValues {
    return RouteLegStepTransitDetails_TransitDetailsLocalizedValues.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RouteLegStepTransitDetails_TransitDetailsLocalizedValues>, I>>(
    object: I,
  ): RouteLegStepTransitDetails_TransitDetailsLocalizedValues {
    const message = createBaseRouteLegStepTransitDetails_TransitDetailsLocalizedValues();
