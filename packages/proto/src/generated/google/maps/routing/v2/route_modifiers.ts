...
import { TollPass, tollPassFromJSON, tollPassToJSON } from "./toll_passes";
...
export const RouteModifiers: MessageFns<RouteModifiers> = {
  ...
  create<I extends Exact<DeepPartial<RouteModifiers>, I>>(base?: I): RouteModifiers {
    return RouteModifiers.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RouteModifiers>, I>>(object: I): RouteModifiers {
    const message = createBaseRouteModifiers();
