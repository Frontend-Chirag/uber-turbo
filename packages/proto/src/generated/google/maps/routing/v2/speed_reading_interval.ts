...
export const SpeedReadingInterval: MessageFns<SpeedReadingInterval> = {
  ...
  create<I extends Exact<DeepPartial<SpeedReadingInterval>, I>>(base?: I): SpeedReadingInterval {
    return SpeedReadingInterval.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SpeedReadingInterval>, I>>(object: I): SpeedReadingInterval {
    const message = createBaseSpeedReadingInterval();
